...
const ShopDetails = () => {
  ...
  useEffect(() => {
    setProduct(shopData?.find(item => item.id == Number(id)))
    console.log(id, shopData?.find(item => item.id == Number(id)))
  }, [id, shopData])
            ...
            <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                <div className="lg:max-w-[570px] w-full">
                  <div className="lg:min-h-[512px] rounded-lg shadow-1 bg-gray-2  relative flex items-center justify-center">
                    <div>
                      <button
                ...
                <div className="max-w-[539px] w-full">
                  ...
                  <ul className="flex flex-col gap-2">
                    {
                      product.benefits?.map((item, id) => (
                        <li className="flex items-center gap-2.5" key={id}>
                          <svg
                            width="20"
                            height="20"
                            viewBox="0 0 20 20"
                  ...
                  <form onSubmit={(e) => e.preventDefault()}>
                    <div className="flex flex-wrap items-center gap-4.5 my-10">
          ...
          <section className="overflow-hidden bg-gray-2 py-20">
            <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              ...
              <div>
                ...
                >
                  ...
                  <div className="max-w-[447px] w-full">
                    ...
                    {
                      product.maintenance?.map((spec, id) => (
                        <p className="mb-6" key={id}>
                          {spec}
                        </p>
                      ))
              ...
              <div>
                ...
                >
                  {
                    product.additional?.map((addtional, id) => (
                      <p className="text-sm sm:text-base text-dark" key={id}>{addtional}</p>
                    ))
                  }
                </div>
              </div>
