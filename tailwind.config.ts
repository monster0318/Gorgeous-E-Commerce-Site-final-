  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        range:
          "0px 0px 1px 10px rgba(33, 37, 41, 0.08), 0px 2px 2px 0px rgba(33, 37, 41, 0.06)",
        ...
        promo1: "rgba(100, 200, 255, 0.3) 0px 3px 9px 5px, rgba(100, 200, 255, 0.2) 0px 8px 9px 10px, rgba(100, 200, 255, 0.1) 0px 5px 10px 10px",
        promo2: "rgba(151, 48, 255, 0.3) 0px 3px 9px 5px, rgba(51, 148, 255, 0.2) 0px 8px 9px 10px, rgba(51, 48, 255, 0.1) 0px 5px 10px 10px",
      },
      backgroundImage: {
        'bank-hero': "url('/images/hero/bank-hero.jpg')",
        'crypto-hero': "url('/images/hero/crypto-hero.png')",
        'social-media-hero': "url('/images/hero/social-media-hero.png')",
        'ads-hero': "url('/images/hero/ads-hero.png')",
        'mail-service-hero': "url('/images/hero/mail-service-hero.png')",
        'review-hero': "url('/images/hero/review-hero.jpg')",
        'social-reaction-hero': "url('/images/hero/social-reaction-hero.jpg')",
       }
    },
  },
  plugins: [],
